package com.amotech.datavoc.cpp.code;
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            if (isInEditMode()) {
                ...
                borderFlagColor = a.getColor(R.styleable.CountryCodePicker_ccp_flagBorderColor, context.getResources().getColor(R.color.black));
            }
